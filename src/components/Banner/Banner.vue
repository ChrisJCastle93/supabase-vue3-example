<template>
    <div v-if="open"
        ...
        <p class="text-sm leading-6 text-gray-900">
            GeneriCon 2023 is on June 7 – 9 in Denver. <a href="#" class="whitespace-nowrap font-semibold">Get your
                ticket&nbsp;<span aria-hidden="true">&rarr;</span></a>
        </p>
        <div class="flex flex-1 justify-end">
            <button type="button" class="-m-3 p-3 focus-visible:outline-offset-[-4px]">
                <span class="sr-only">Dismiss</span>
                <XMarkIcon @click="closeBanner" class="h-5 w-5 text-gray-900" aria-hidden="true" />
            </button>
        </div>
    </div>
</template>
